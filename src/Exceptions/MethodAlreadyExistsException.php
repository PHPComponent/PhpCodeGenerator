 ...
 */
class MethodAlreadyExistsException extends \InvalidArgumentException
{
    ...
    {
        $this->method_name = $constant_name;
        if($message === '') $message = 'Method '.$constant_name.' already exists';
